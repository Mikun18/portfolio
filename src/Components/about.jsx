  ...
  return (
    <section>
        ...
        <article className='about-con'>
          ...
          <p>Then he picked up React during the end of his first year. The learning process spanned for about 5 months and at this point, his CSS3 skills were getting a lot better. So he started cloning websites and developing some. You can check them out <a href='http://localhost:3000/#portfolio'>here</a>.</p>
          <p>Mikun has taught and also encouraged a lot of his peers to go into web development. He teaches </p>
          <p>Mikun is currently working as a freelance frontend web developer and he is always interested in a challenge. Reach out to Mikun <a href='http://localhost:3000/#contact'>here</a> to connect!</p>
          <p></p>
        </article>
    </section>
  )
