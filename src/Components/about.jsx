  ...
  return (
    <section>
        ...
        <article className='about-con'>
          ...
          <p>Then he picked up React during the end of his first year. The learning process spanned for about 5 months and at this point, his CSS3 skills were getting a lot better. So he started cloning websites and developing some. You can check them out <Link to='/#portfolio'>here</Link>.</p>
          <p>Mikun is currently working as a freelance frontend web developer and he is always interested in a challenge. Reach out to Mikun <Link to='/#contact'>here</Link> to connect!</p>
        </article>
    </section>
  )
}
